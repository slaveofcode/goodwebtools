...
| Layout | **Fluid width, mobile-first** | Shared `.page-container` (full-width, adaptive gutters, capped at 100rem) so tools use the screen; multi-pane tools collapse to one column on mobile. |
