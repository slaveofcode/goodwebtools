...
export const tools: ToolDef[] = [
  ...
  },
  {
    ...
    name: 'Block Puzzle',
    category: 'Games',
    route: '/tools/block-puzzle',
    keywords: ['block puzzle', 'blocks game', '8x8 puzzle', 'drag blocks', 'line clear puzzle', 'puzzle blok', 'game puzzle'],
    icon: ToyBrick,
    summary: 'Drag pieces onto an 8×8 board — clear full rows & columns',
    load: () => import('@/islands/games/BlockPuzzle'),
    status: 'beta'
  },
  {
    id: 'dino-run',
    name: 'Dino Run',
    category: 'Games',
    route: '/tools/dino-run',
    keywords: ['dino game', 'dinosaur game', 'offline game', 'endless runner', 'jump game', 'game dino', 'game lari'],
    icon: Footprints,
    summary: 'Endless runner with double jump, ducking & day/night cycles',
    load: () => import('@/islands/games/DinoRun'),
    status: 'beta'
  },
  {
    id: 'fruit-merge',
    name: 'Fruit Merge',
    category: 'Games',
    route: '/tools/fruit-merge',
    keywords: ['fruit merge', 'suika', 'suika game', 'watermelon game', 'merge game', 'drop fruit', 'physics puzzle', 'gabung buah', 'buah', 'game semangka'],
    icon: Apple,
    summary: 'Suika-style physics puzzle — drop & merge fruits into a watermelon',
    load: () => import('@/islands/games/FruitMerge'),
    status: 'beta'
  },
  {
    id: 'snake',
    ...
    category: 'Games',
    route: '/tools/snake',
    keywords: ['snake game', 'classic snake', 'snake online', 'retro snake', 'game ular', 'ular'],
    icon: Rabbit,
    summary: 'Classic snake with bonus food, wall wrap & queued turns',
    load: () => import('@/islands/games/SnakeGame'),
    status: 'beta'
  },
  {
    id: 'onet',
    ...
    category: 'Games',
    route: '/tools/onet',
    keywords: ['onet', 'onet connect', 'tile match game', 'connect pairs', 'pikachu game', 'game onet', 'cocokkan ubin'],
    icon: Link2,
    summary: 'Match tile pairs joined by a line with at most two turns',
    load: () => import('@/islands/games/OnetGame'),
    status: 'beta'
  },
  {
    id: 'pdf-organize',
  ...
  },
  {
    ...
    category: 'Playground',
    route: '/tools/notepad',
    keywords: ['notepad', 'online notepad', 'notes', 'scratchpad', 'text editor', 'autosave', 'quick note'],
    icon: PenLine,
    summary: 'A fast notepad that autosaves to your browser',
    load: () => import('@/islands/playground/Notepad'),
    status: 'beta'
  },
  {
    id: 'todo',
    ...
    category: 'Playground',
    route: '/tools/todo',
    keywords: ['todo', 'to-do list', 'task list', 'checklist', 'sticky notes', 'quick tasks', 'reminders'],
    icon: StickyNote,
    summary: 'A quick to-do list that saves to your browser',
    load: () => import('@/islands/playground/StickyTodo'),
    status: 'beta'
  },
  {
    id: 'whiteboard',
